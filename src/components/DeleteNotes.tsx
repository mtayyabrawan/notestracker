...
function DeleteNotes() {
  ...
  return (
    <div className="space-y-8 p-4">
      <h2 className="text-sm font-medium text-neutral-700">Delete Notes</h2>
      <div className="flex items-center justify-between px-2 py-5">
        <div className="w-1/2 px-4 py-6 text-justify text-xs leading-loose">
          This action is irreversible. When you delete all of your notes they
        ...
        {open && <DeleteNotesModal handleModal={handleModal} />}
      </div>
    </div>
  );
}
